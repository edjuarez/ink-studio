...
export default function ActionButton({
  ...
  return (
    <FadeIn className="mt-16 flex justify-center">
      <div className={`border-1 p-1 ${current.wrapper}`}>
        <Link
          to={href}
          className={`text-[0.75rem] group relative flex items-center gap-3 overflow-hidden border-1 px-5 py-3.5 uppercase tracking-[0.15em] ${current.button}`}
        >
          <span
